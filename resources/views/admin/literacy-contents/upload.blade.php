...
@section('title', 'Bulk Upload Literacy Content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex items-center gap-3">
            <a href="{{ route('admin.literacy-contents.index') }}"
               ...
               title="Back to Literacy Contents">
            ...
            <div>
                ...
                <p class="mt-1 text-gray-600">Import literacy content via Excel</p>
            </div>
        </div>
    </div>
@endsection
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.literacy-contents.upload') }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    ...
                    <!-- File Upload -->
                                ...
                                <div class="ml-3 flex-1">
                                    ...
                                    <div class="mt-2 text-sm text-blue-700">
                                        <ul class="list-disc list-inside space-y-1">
                                            ...
                                            <li>Required fields: Title, Type, Category</li>
                                            <li>At least Content OR URL must be provided</li>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="{{ route('admin.literacy-contents.download-template') }}"
        ...
        <div class="space-y-6">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-0.5">Add your literacy content following the format</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-3">
                ...
                <div class="p-6">
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between text-sm">
                            ...
                            <span class="text-amber-600 font-medium">Conditional</span>
                        </div>
                        <div class="flex items-center justify-between text-sm">
                        ...
                        <div class="flex items-center justify-between text-sm">
                            <span class="text-gray-700">Platform ID</span>
                            <span class="text-green-600 font-medium">Optional</span>
                        </div>
                    </div>
                    <div class="mt-4 pt-4 border-t border-gray-100">
                        <p class="text-xs text-gray-500">
                            <span class="text-red-600 font-medium">Conditional:</span> At least Content OR URL must be provided
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                    <h3 class="text-sm font-semibold text-gray-800">Type Options</h3>
                </div>
                <div class="p-6">
                    <div class="space-y-2">
                        <div class="flex items-center gap-2">
                            <div class="w-3 h-3 rounded-full bg-blue-500"></div>
                            <span class="text-sm text-gray-700">article</span>
                            <span class="text-xs text-gray-500 ml-auto">For text content</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <div class="w-3 h-3 rounded-full bg-purple-500"></div>
                            <span class="text-sm text-gray-700">video</span>
                            <span class="text-xs text-gray-500 ml-auto">For video content</span>
                        </div>
                    </div>
                </div>
            </div>
