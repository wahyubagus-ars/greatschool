...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
        @forelse($contents as $content)
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-200">
                ...
                <div class="p-5">
                    ...
                    <h3 class="font-semibold text-gray-800 line-clamp-2 hover:text-indigo-600 transition-colors min-h-[48px] text-base">
        ...
        @empty
            <div class="col-span-full bg-white rounded-xl border-2 border-dashed border-gray-300 p-8 text-center">
    ...
    <!-- Safety Notice -->
    <div class="mt-10 p-5 bg-blue-50 rounded-xl border border-blue-200">
