        ...
        <div class="p-5 md:p-6">
            ...
            <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $quiz->duration_minutes }} minutes</p>
                </div>
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $quiz->points_per_quiz ?? 10 }} per question</p>
                </div>
            </div>

            @if($quiz->literacyContents->count() > 0)
                <div class="mt-8">
                    <h2 class="text-lg font-semibold text-gray-900 mb-4">Required Literacy Materials</h2>
                    <div class="space-y-3">
            ...
            <div class="mt-10 pt-6 border-t border-gray-200">
                @if($taken)
                    <div class="bg-green-50 rounded-xl p-5 text-center">
                        ...
                        <p class="text-lg font-medium text-green-800">Quiz Completed</p>
                        <p class="mt-2 text-gray-600">You've already completed this quiz. View your results below.</p>
                ...
                @else
                    ...
                    @else
                        <div class="bg-yellow-50 rounded-xl p-5 text-center">
                            ...
                            <p class="text-lg font-medium text-yellow-800">Complete Required Materials First</p>
                            <p class="mt-2 text-gray-600">
                                You need to view all required literacy materials before taking this quiz.
                            </p>
