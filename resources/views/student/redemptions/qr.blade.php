...
@section('title', 'Redemption Code')

@section('page-header')
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">Your Redemption Code</h1>
            <p class="mt-1 text-gray-600">Show this code to canteen staff</p>
        </div>
    ...
    <div class="max-w-md mx-auto">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="p-6 text-center border-b border-gray-200">
                ...
                <div class="mt-4">
                    <p class="text-sm text-gray-500 mb-2">Redemption Code</p>
                    ...
                    <p class="mt-2 text-xs text-gray-500">
                        💡 Tip: Read this code aloud to canteen staff if QR won't scan
                    </p>
                </div>

                <p class="mt-4 text-sm text-gray-500">
                    Valid until: <span class="font-medium text-gray-900">{{ $redemption->expires_at->format('H:i:s') }}</span>
                </p>
            </div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-2 gap-4 mb-6">
                    ...
                    <div class="bg-green-50 rounded-lg p-4 text-center">
                        <p class="text-sm text-green-700">Voucher Value</p>
                ...
                <div class="bg-amber-50 rounded-xl p-4 border border-amber-200 mb-6">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium text-amber-800">Important Notes</p>
                            <ul class="mt-1 text-sm text-amber-700 space-y-1">
                                <li>• Code expires in 15 minutes</li>
                                <li>• Each code can only be used once</li>
                                <li>• Show QR or tell staff the 8-character code</li>
                                <li>• Keep this code private - don't share with others</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="mt-6 text-center">
            ...
            <p class="mt-1 text-sm text-gray-500">Time remaining before code expires</p>
        </div>
    </div>
