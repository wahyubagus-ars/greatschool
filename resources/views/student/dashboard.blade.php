...
@section('content')
        ...
        <div class="divide-y divide-gray-100">
            ...
            @empty
                <div class="px-5 py-10 sm:py-14 text-center">
                    <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gray-50 mx-auto mb-5">
    ...
    <div class="mt-8 sm:hidden grid grid-cols-2 gap-4">
        <a href="{{ route('student.literacy.index') }}" class="flex flex-col items-center justify-center p-5 bg-white rounded-2xl border border-gray-200 hover:shadow-md transition-shadow">
            <div class="p-3 bg-indigo-50 rounded-xl mb-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="w-7 h-7 text-indigo-600">
