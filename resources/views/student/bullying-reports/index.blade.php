...
@section('page-header')
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">My Bullying Reports</h1>
            <p class="mt-1 text-gray-600">View and track your submitted bullying reports</p>
        </div>
...
@section('content')
    @if($reports->isEmpty())
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
            ...
            <h3 class="text-lg font-semibold text-gray-800 mb-2">No reports yet</h3>
            <p class="text-gray-500 mb-6 max-w-md mx-auto">
                You haven't submitted any bullying reports. Reporting helps keep our school safe for everyone.
            </p>
            <a href="{{ route('student.bullying-reports.create') }}"
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tr>
                        <th scope="col" class="px-6 py-4 text-left text-sm font-semibold text-gray-700 uppercase tracking-wider">Title</th>
                        <th scope="col" class="px-6 py-4 text-left text-sm font-semibold text-gray-700 uppercase tracking-wider">Date</th>
