...
<div class="w-full max-w-md">
    ...
    <div class="flex justify-end mb-4 space-x-2 text-xs font-semibold uppercase tracking-wider">
        <a href="{{ route('lang.switch', 'en') }}"
           class="{{ app()->getLocale() == 'en' ? 'text-indigo-800 border-b-2 border-indigo-800' : 'text-indigo-400 hover:text-indigo-600' }}">
            EN
        </a>
        <span class="text-indigo-300">|</span>
        <a href="{{ route('lang.switch', 'id') }}"
           class="{{ app()->getLocale() == 'id' ? 'text-indigo-800 border-b-2 border-indigo-800' : 'text-indigo-400 hover:text-indigo-600' }}">
            ID
        </a>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
        ...
        <div class="px-8 pt-8 pb-6 text-center border-b border-gray-100">
            ...
            <h1 class="text-2xl font-bold text-gray-800">{{ __('Student Portal') }}</h1>
            <p class="text-gray-500 mt-1">{{ __('Sign in to access your academic resources') }}</p>
        </div>
    ...
    <!-- Form -->
        <div class="p-8">
            ...
            <!-- NIS Field -->
                <div>
                    <label for="nis" class="block text-sm font-medium text-gray-700 mb-1.5">{{ __('Student ID (NIS)') }}</label>
                    <div class="relative">
    ...
    <div class="mt-6 text-center text-xs text-gray-500">
        <p>{{ __('Laravel v:version • Secure Connection', ['version' => app()->version()]) }}</p>
    </div>
</div>
</body>
</html>
